...
for(let i = 0; i<optionGroups.length; i++){
	...
	main+=`<h3>${i+1}.この地名はなんて読む？</h3>`
         ...
         +`<li class='buttonOfOptionNumber2' id = 'answerChoice_${i}_1' input type='button' value='button' onclick="clickSelectedButton(${i},1,0)">${optionGroups[i][1]}</li>`
         +`<li class='buttonOfOptionNumber3' id = 'answerChoice_${i}_2' input type='button' value='button' onclick="clickSelectedButton(${i},2,0)">${optionGroups[i][2]}</li>`
