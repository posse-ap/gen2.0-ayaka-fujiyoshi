...
$contents_name_array = [];
for ($k=0; $k < count($results_contents); $k++) {    //$results_contents.lengthとかに後で
  array_push($contents_name_array, $results_contents[$k]['contents_name']);
}
$contents_hour_array = [];
for ($h=0; $h < count($results_contents); $h++) {    //$results_contents.lengthとかに後で
...
for ($c=0; $c < count($results_languages); $c++) {    //$results_languages.lengthとかに後で
