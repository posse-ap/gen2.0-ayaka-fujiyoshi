...
define('PDO_DSN',"mysql:host=mysql;dbname=" . $DATABASE_NAME . ";" . $CHARACTER_CODE . ";");
// define('PDO_DSN','mysql:host=localhost;dbname=dbname;charset=utf8');
define('DB_USERNAME','mysql');
define('DB_PASSWORD','password');
define('OPTIONS','password');
